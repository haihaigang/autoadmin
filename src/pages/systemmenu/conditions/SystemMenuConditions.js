...
import CONDITIONS_DATA from '../../../robots/SystemMenu/conditions/SystemMenuConditions'

/**
 * 拼团活动的搜索条件
 */
class SystemMenuConditions extends BaseConditions {
    constructor() {
        super();
...
export default SystemMenuConditions;
