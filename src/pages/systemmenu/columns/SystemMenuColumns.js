...
import COLUMNS_DATA from '../../../robots/SystemMenu/columns/SystemMenuColumns'
import TYPES_TO_RENDERS from './SystemMenuTypesToRenders'

/**
 * 拼团活动的表头
 */
class SystemMenuColumns extends BaseColumns {
    constructor() {
        super();
...
export default SystemMenuColumns;
